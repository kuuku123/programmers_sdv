...
K_MAX = 40     # maximum curvature [1/m]
...
def stanley_control(x, y, yaw, v, map_xs, map_ys, map_yaws):
    # find nearest point
    global close_x, close_y, close_yaw 
    min_dist = 1e9
    min_index = 0
    n_points = len(map_xs)
    ...
    close_x = map_xs[min_index]
    close_y = map_ys[min_index]
    close_yaw = map_yaws[min_index]
...
if __name__ == "__main__":
    ...
    marker_pub = rospy.Publisher("/might_be_route" + str(id), Marker, queue_size=1)
    ...
    while not rospy.is_shutdown():
        ...
        #msg2 = get_ros_msg2(close_x, close_y, close_yaw, state.v, id=id)
        ...
        #marker_pub.publish(msg2["marker_msg"])
        r.sleep()
